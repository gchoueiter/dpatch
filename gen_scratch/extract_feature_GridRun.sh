...
#$ -o /data/hays_lab/people/gen/grid_output/class_attr/$JOB_ID.$TASK_ID.out
#$ -e /data/hays_lab/people/gen/grid_output/class_attr/$JOB_ID.$TASK_ID.err

# ================= RUN GRID JOB ================

matlabpath=/local/bin/matlab-r2011b

echo "EXECUTING COMMAND: extract_feature_GridWrapper( " $SGE_TASK_ID ")"
...
$matlabpath -nodesktop -nodisplay -nosplash -r "extract_feature_GridWrapper $SGE_TASK_ID"