...
echo "EXECUTING COMMAND: extract_feature_GridWrapper( " $SGE_TASK_ID " , 3, 2 )"
...
$matlabpath -nodesktop -nodisplay -nosplash -r "extract_feature_GridWrapper $SGE_TASK_ID 3 2"