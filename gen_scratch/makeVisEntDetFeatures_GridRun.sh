...
echo "EXECUTING COMMAND: makeVisEntDetFeatures_GridWrapper( " $SGE_TASK_ID " , "$1", "$2" )"
...
$matlabpath -nodesktop -nodisplay -nosplash -r "makeVisEntDetFeatures_GridWrapper $SGE_TASK_ID $1 $2"