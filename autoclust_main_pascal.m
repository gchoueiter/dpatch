...
ranking=1;
   ...
   patch_dir{1}=['/data/hays_lab/finder/Discriminative_Patch_Discovery/' ...
                'pascal_07_patches/overallcounts'];%['/home/gen/pascal_07_patches/overallcounts'];%

   patch_dir{2}=['/data/hays_lab/finder/Discriminative_Patch_Discovery/' ...
                'pascal_07_patches/posterior'];%['/home/gen/pascal_07_patches/posterior'];%

if(~exist(patch_dir{1}, 'dir'))
    mkdir(patch_dir{1});
end

if(~exist(patch_dir{2}, 'dir'))
    mkdir(patch_dir{2});
end
%keyboard
...
disppats=find(ismember(ds.assignedClust,ds.selectedClust(1:min(1200, length(ds.selectedClust)))));
